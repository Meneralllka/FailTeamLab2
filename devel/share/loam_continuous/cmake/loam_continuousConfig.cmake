...
if("TRUE" STREQUAL "TRUE")
  set(loam_continuous_SOURCE_PREFIX /home/abdra/catkin_ws/src/loam_continuous)
  set(loam_continuous_DEVEL_PREFIX /home/abdra/catkin_ws/devel)
  ...
  set(loam_continuous_INSTALL_PREFIX /home/abdra/catkin_ws/install)
...
if(NOT "/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2;/usr/include/opencv4 " STREQUAL " ")
  set(loam_continuous_INCLUDE_DIRS "")
  set(_include_dirs "/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'loam_continuous' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'loam_continuous' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/abdra/catkin_ws/src/loam_continuous/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT loam_continuous_NUM_DUMMY_TARGETS)
      set(loam_continuous_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::loam_continuous::wrapped-linker-option${loam_continuous_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR loam_continuous_NUM_DUMMY_TARGETS "${loam_continuous_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::loam_continuous::wrapped-linker-option${loam_continuous_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND loam_continuous_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/abdra/catkin_ws/devel/lib;/home/abdra/catkin_ws/devel/lib;/opt/ros/noetic/lib)
...
set(depends "geometry_msgs;nav_msgs;roscpp;rospy;std_msgs;pcl_ros")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${loam_continuous_dep}_FOUND)
      find_package(${loam_continuous_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${loam_continuous_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(loam_continuous_EXPORTED_TARGETS ${${loam_continuous_dep}_EXPORTED_TARGETS})
endforeach()
